...
function Section_4() {
    return(
        ...
        <div>
    <Image src={collage} alt="collage" className="px-4 mt-[20px] h-[500px] w-[600px] lg:h-[651px] lg:ml-[80px] " />
  </div>
  <div>
    {/* <div> 
  ...
  <Image src={plane} alt="Image description" className="ml-[280px] mb-4 lg:mb-4 w-[10%] lg:w-[9%]" />
  <p className="mt-[-20px]  ">
    Meet international 
...
<p className="lg:hidden text-[16px] py-6 px-4 font-roboto">Morbi sit egestas dignissim pharetra, sed amet. Tempus justo senectus risus ac vel, velit, nunc. Eget commodo eget in aliquam facilisi facilisi nec magna hendrerit. Placerat ipsum sit tellus urna, faucibus aenean lorem faucibus integer.</p>
    <button className=" inline-block after:content-['→'] after:ml-2 lg:ml-[20px] px-4 font-medium font-roboto text-blue-500 lg:text-[20px] text-[16px]">Explore teachers and students</button>
  </div>
