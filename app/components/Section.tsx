...
function Section(){
  ...
  <span className="underline decoration-4 decoration-orange-500">Teach</span> Student <br />Worldwide
</p>
    <p className="mt-10 leading-[1.2] lg:leading-[0.75]">
  ...
  <div className="w-full mt-10 flex flex-col lg:flex-row lg:items-center lg:space-x-8">
